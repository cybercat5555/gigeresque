            ...
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        ...
                        Constants.modResource("alexsmobscompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("caracal"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("caracalcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("friendsandfoes"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("friendsandfoescompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("graveyard"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("graveyardcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("illagerinvasion"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("illagerinvasioncompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("twilightforest"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("twilightforestcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("jarjarbinks"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("jarjarcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("arachnids"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("arachnidscompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("aftershock"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("aftershockcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("livingthings"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("livingthingscompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("ydms_redpanda"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("ydms_redpandacompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("mca"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("mcacompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("cave_dweller"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("cavedwellercompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("betterend"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("betterendcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("ad_astra"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("adastracompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("promenade"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("promenadecompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("hwg"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("hwgcompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("aether"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("aethercompat"),
                        modContainer,
                        Component.literal("aethercompat"),
                        ResourcePackActivationType.DEFAULT_ENABLED
                    ))
                );
        ...
        if (FabricLoader.getInstance().isModLoaded("alexscaves"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("alexscavescompat"),
                        modContainer,
        ...
        if (FabricLoader.getInstance().isModLoaded("stellaris"))
            FabricLoader.getInstance()
                ...
                .ifPresent(
                    (modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(
                        // Mod Compat datapack found in resources/resourcepacks
                        Constants.modResource("stellariscompat"),
                        modContainer,
