    ...
    public static void onConstructMod(final AddPackFindersEvent event) {
        if (ModList.get().isLoaded("alexsmobs"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/alexsmobscompat"),
        ...
        if (ModList.get().isLoaded("caracal"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/caracalcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("friendsandfoes"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/friendsandfoescompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("graveyard"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/graveyardcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("illagerinvasion"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/illagerinvasioncompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("twilightforest"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/twilightforestcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("jarjarbinks"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/jarjarcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("arachnids"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/arachnidscompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("aftershock"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/aftershockcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("livingthings"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/livingthingscompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("ydms_redpanda"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/ydms_redpandacompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("mca"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/mcacompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("cave_dweller"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/cavedwellercompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("betterend"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/betterendcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("ad_astra"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/adastracompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("promenade"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/promenadecompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("hwg"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/hwgcompat"),
                PackType.SERVER_DATA,
        ...
        if (ModList.get().isLoaded("aethercompat"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/aethercompat"),
                PackType.SERVER_DATA,
                Component.literal("alexsmobscompat"),
                PackSource.FEATURE,
                true,
        ...
        if (ModList.get().isLoaded("alexscaves"))
            event.addPackFinders(
                Constants.modResource("resourcepacks/alexscavescompat"),
                PackType.SERVER_DATA,
