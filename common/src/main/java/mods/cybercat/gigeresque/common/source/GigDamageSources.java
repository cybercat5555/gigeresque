...
public record GigDamageSources() {
    ...
    public static final ResourceKey<DamageType> FAILED_SURGERY = ResourceKey.create(
        Registries.DAMAGE_TYPE,
        Constants.modResource("failed_surgery")
    );

    public static final ResourceKey<DamageType> CHESTBURSTING = ResourceKey.create(
        Registries.DAMAGE_TYPE,
        Constants.modResource("chestburst")
    );
    ...
    public static final ResourceKey<DamageType> EXECUTION = ResourceKey.create(
        Registries.DAMAGE_TYPE,
        Constants.modResource(list.get(randomIndex))
    );
