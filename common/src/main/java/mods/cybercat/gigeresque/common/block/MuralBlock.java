...
public class MuralBlock extends GigBlock {
    ...
    public MuralBlock() {
        super(Properties.of().strength(3.0F, 6.0F).sound(SoundType.NETHERRACK).explosionResistance(10));
    }
    ...
    public void playerDestroy(
        ...
        if (level instanceof ServerLevel serverLevel) {
            serverLevel.setBlock(pos, GigBlocks.ROUGH_ALIEN_BLOCK.get().defaultBlockState(), Block.UPDATE_ALL);
