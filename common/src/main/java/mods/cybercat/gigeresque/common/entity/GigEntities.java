...
//    public static final Supplier<EntityType<ClassicAlienEntity>> ROM_ALIEN = CommonEntityRegistryInterface.registerEntity(
//            CommonMod.MOD_ID, EntityIdentifiers.ROM_ALIEN.getPath(), ClassicAlienEntity::new, MobCategory.MONSTER, 0.9f, 1.95f);
    ...
    public static final Supplier<EntityType<HellbursterEntity>> HELL_BURSTER = CommonEntityRegistryInterface.registerEntity(
            CommonMod.MOD_ID, EntityIdentifiers.HELL_BURSTER.getPath(), HellbursterEntity::new, MobCategory.MONSTER, 0.5f, 0.5f);
    ...
    public static final Supplier<EntityType<AquaEggEntity>> AQUA_EGG = CommonEntityRegistryInterface.registerEntity(
            CommonMod.MOD_ID, EntityIdentifiers.AQUA_EGG.getPath(), AquaEggEntity::new, MobCategory.MISC, 0.7f, 0.9f);
