...
public record GigEntities() implements CommonEntityRegistryInterface, CommonBlockEntityRegistryInterface {
    ...
    // public static final Supplier<EntityType<ClassicAlienEntity>> ROM_ALIEN =
    ...
    public static final Supplier<EntityType<RavenousTempleBeastEntity>> RAVENOUSTEMPLEBEAST = CommonEntityRegistryInterface.registerEntity(
        ...
        RavenousTempleBeastEntity::new,
        MobCategory.MONSTER,
        1.6f,
        3.95f
    );

    public static final Supplier<EntityType<MoonlightHorrorTempleBeastEntity>> MOONLIGHTHORRORTEMPLEBEAST = CommonEntityRegistryInterface
        .registerEntity(
            CommonMod.MOD_ID,
            EntityIdentifiers.MOONLIGHTHORRORTEMPLEBEAST.getPath(),
            MoonlightHorrorTempleBeastEntity::new,
            MobCategory.MONSTER,
            2.1f,
            4.95f
        );
    ...
    public static final Supplier<EntityType<HellmorphRunnerEntity>> HELLMORPH_RUNNER = CommonEntityRegistryInterface.registerEntity(
        CommonMod.MOD_ID,
        EntityIdentifiers.HELLMORPH_RUNNER.getPath(),
        HellmorphRunnerEntity::new,
        MobCategory.MONSTER,
        2.1f,
        2.45f
    );
    ...
    public static final Supplier<EntityType<BaphomorphEntity>> BAPHOMORPH = CommonEntityRegistryInterface.registerEntity(
        CommonMod.MOD_ID,
        EntityIdentifiers.BAPHOMORPH.getPath(),
        BaphomorphEntity::new,
        MobCategory.MONSTER,
        2.1f,
        3.95f
    );

    public static final Supplier<EntityType<HellbursterEntity>> HELL_BURSTER = CommonEntityRegistryInterface.registerEntity(
        CommonMod.MOD_ID,
        EntityIdentifiers.HELL_BURSTER.getPath(),
        HellbursterEntity::new,
        MobCategory.MONSTER,
        0.5f,
        0.5f
    );
    ...
    public static final Supplier<EntityType<AcidSpitProjectile>> ACID_PROJECTILE = CommonEntityRegistryInterface.registerEntity(
        CommonMod.MOD_ID,
    ...
    public static final Supplier<EntityType<HologramEntity>> ENGINEER_HOLOGRAM = CommonEntityRegistryInterface.registerEntity(
        CommonMod.MOD_ID,
        EntityIdentifiers.ENGINEER_HOLOGRAM.getPath(),
        HologramEntity::new,
        MobCategory.MISC,
        2.1f,
        4.95f
    ...
    public static final Supplier<EntityType<AquaEggEntity>> AQUA_EGG = CommonEntityRegistryInterface.registerEntity(
        CommonMod.MOD_ID,
        EntityIdentifiers.AQUA_EGG.getPath(),
        AquaEggEntity::new,
        MobCategory.MISC,
        0.7f,
        0.9f
    ...
    public static final Supplier<BlockEntityType<AlienStorageEntity>> ALIEN_STORAGE_BLOCK_ENTITY_1 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "alien_storage_block_entity",
            () -> BlockEntityType.Builder.of(
                AlienStorageEntity::new,
                GigBlocks.ALIEN_STORAGE_BLOCK_1.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<AlienStorageHuggerEntity>> ALIEN_STORAGE_BLOCK_ENTITY_1_HUGGER =
        CommonBlockEntityRegistryInterface.registerBlockEntity(
            CommonMod.MOD_ID,
            "alien_storage_block_entity_hugger",
            () -> BlockEntityType.Builder.of(
                AlienStorageHuggerEntity::new,
                GigBlocks.ALIEN_STORAGE_BLOCK_1_HUGGER.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<AlienStorageGooEntity>> ALIEN_STORAGE_BLOCK_ENTITY_1_GOO =
        CommonBlockEntityRegistryInterface.registerBlockEntity(
            CommonMod.MOD_ID,
            "alien_storage_block_entity_goo",
            () -> BlockEntityType.Builder.of(
                AlienStorageGooEntity::new,
                GigBlocks.ALIEN_STORAGE_BLOCK_1_GOO.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<AlienStorageSporeEntity>> ALIEN_STORAGE_BLOCK_ENTITY_1_SPORE =
        CommonBlockEntityRegistryInterface.registerBlockEntity(
            CommonMod.MOD_ID,
            "alien_storage_block_entity_spore",
            () -> BlockEntityType.Builder.of(
                AlienStorageSporeEntity::new,
                GigBlocks.ALIEN_STORAGE_BLOCK_1_SPORE.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<JarStorageEntity>> ALIEN_STORAGE_BLOCK_ENTITY_2 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "alien_storage_jar_entity",
            () -> BlockEntityType.Builder.of(
    ...
    public static final Supplier<BlockEntityType<IdolStorageEntity>> ALIEN_STORAGE_BLOCK_ENTITY_3 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "sitting_idol_entity",
            () -> BlockEntityType.Builder.of(
                IdolStorageEntity::new,
                GigBlocks.ALIEN_STORAGE_BLOCK_3.get()
            ).build(null)
        );
    ...
    public static final Supplier<BlockEntityType<SporeBlockEntity>> SPORE_ENTITY = CommonBlockEntityRegistryInterface.registerBlockEntity(
        ...
        () -> BlockEntityType.Builder.of(
            ...
            GigBlocks.SPORE_BLOCK.get()
        ).build(null)
    );

    public static final Supplier<BlockEntityType<PetrifiedOjbectEntity>> PETRIFIED_OBJECT = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "petrified_object",
            () -> BlockEntityType.Builder.of(
                PetrifiedOjbectEntity::new,
                GigBlocks.PETRIFIED_OBJECT_BLOCK.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<PetrifiedOjbect1Entity>> PETRIFIED_OBJECT_1 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "petrified_object_1",
            () -> BlockEntityType.Builder.of(
                PetrifiedOjbect1Entity::new,
                GigBlocks.PETRIFIED_OBJECT_1_BLOCK.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<PetrifiedOjbect2Entity>> PETRIFIED_OBJECT_2 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "petrified_object_2",
            () -> BlockEntityType.Builder.of(
                PetrifiedOjbect2Entity::new,
                GigBlocks.PETRIFIED_OBJECT_2_BLOCK.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<PetrifiedOjbect3Entity>> PETRIFIED_OBJECT_3 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "petrified_object_3",
            () -> BlockEntityType.Builder.of(
                PetrifiedOjbect3Entity::new,
                GigBlocks.PETRIFIED_OBJECT_3_BLOCK.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<PetrifiedOjbect4Entity>> PETRIFIED_OBJECT_4 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "petrified_object_4",
            () -> BlockEntityType.Builder.of(
                PetrifiedOjbect4Entity::new,
                GigBlocks.PETRIFIED_OBJECT_4_BLOCK.get()
            ).build(null)
        );

    public static final Supplier<BlockEntityType<PetrifiedOjbect5Entity>> PETRIFIED_OBJECT_5 = CommonBlockEntityRegistryInterface
        .registerBlockEntity(
            CommonMod.MOD_ID,
            "petrified_object_5",
            () -> BlockEntityType.Builder.of(
                PetrifiedOjbect5Entity::new,
                GigBlocks.PETRIFIED_OBJECT_5_BLOCK.get()
            ).build(null)
        );
