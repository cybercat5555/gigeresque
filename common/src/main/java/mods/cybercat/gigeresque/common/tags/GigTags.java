...
public record GigTags() {
    ...
    public static final TagKey<EntityType<?>> AQUATIC_HOSTS = TagKey.create(
        ...
        Constants.modResource("aquaticalienhost")
    );

    public static final TagKey<EntityType<?>> CLASSIC_HOSTS = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("classicalienhost")
    );

    public static final TagKey<EntityType<?>> RUNNER_HOSTS = TagKey.create(Registries.ENTITY_TYPE, Constants.modResource("runnerhost"));

    public static final TagKey<EntityType<?>> MUTANT_SMALL_HOSTS = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("smallmutanthost")
    );

    public static final TagKey<EntityType<?>> MUTANT_LARGE_HOSTS = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("largemutanthost")
    );
    ...
    public static final TagKey<EntityType<?>> FACEHUGGER_BLACKLIST = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("facehuggerblacklist")
    );

    public static final TagKey<EntityType<?>> XENO_EXECUTE_BLACKLIST = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("xenoexecuteblacklist")
    );

    public static final TagKey<EntityType<?>> XENO_ATTACK_BLACKLIST = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("xenoattackblacklist")
    );

    public static final TagKey<EntityType<?>> SMALL_XENO_ATTACK_BLACKLIST = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("smallxenoattackblacklist")
    );
    ...
    public static final TagKey<EntityType<?>> GIG_CLASSIC = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("gigeresqueclassic")
    );

    public static final TagKey<EntityType<?>> GIG_RUNNERS = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("gigeresquerunners")
    );

    public static final TagKey<EntityType<?>> GIG_MUTANTS = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("gigeresquemutants")
    );

    public static final TagKey<EntityType<?>> GIG_NEOS = TagKey.create(Registries.ENTITY_TYPE, Constants.modResource("gigeresqueneos"));

    public static final TagKey<EntityType<?>> GIG_TEMPLEBEASTS = TagKey.create(
        Registries.ENTITY_TYPE,
        Constants.modResource("gigeresquetemplebeasts")
    );
    ...
    /* GAMEEVENT TAGS */
    public static final TagKey<GameEvent> ALIEN_CAN_LISTEN = TagKey.create(
        Registries.GAME_EVENT,
        Constants.modResource("alien_can_listen")
    );
