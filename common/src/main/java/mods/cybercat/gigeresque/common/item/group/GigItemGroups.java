    ...
    public static final Supplier<CreativeModeTab> BLOCKS = GigServices.COMMON_REGISTRY.registerCreativeModeTab(
        ...
        () -> GigServices.COMMON_REGISTRY.newCreativeTabBuilder()
            ...
            .displayItems((enabledFeatures, entries) -> {
                ...
                entries.accept(GigBlocks.ROUGH_FRAGILE_ALIEN_BLOCK.get());
                ...
                entries.accept(GigBlocks.PETRIFIED_OBJECT_1_BLOCK.get());
                entries.accept(GigBlocks.PETRIFIED_OBJECT_2_BLOCK.get());
