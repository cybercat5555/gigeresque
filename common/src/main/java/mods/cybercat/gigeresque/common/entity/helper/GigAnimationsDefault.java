...
public record GigAnimationsDefault() {
    ...
    public static final RawAnimation STATIS_ENTER = RawAnimation.begin()
        .then(
            "stasis_enter",
            Animation.LoopType.PLAY_ONCE
        )
        .thenLoop("stasis_loop");
    ...
    /* EGG ANIMATIONS */
    public static final RawAnimation HATCHING = RawAnimation.begin()
        .then("hatch", Animation.LoopType.PLAY_ONCE)
        .thenPlayAndHold(
            "hatched"
        );
    ...
    public static final RawAnimation ATTACK_NORMAL = RawAnimation.begin().then("attack_normal", Animation.LoopType.PLAY_ONCE);

    public static final RawAnimation ATTACK_HEAVY = RawAnimation.begin().then("attack_heavy", Animation.LoopType.PLAY_ONCE);

    public static final RawAnimation LEFT_CLAW = RawAnimation.begin().then("left_claw", Animation.LoopType.PLAY_ONCE);

    public static final RawAnimation RIGHT_CLAW = RawAnimation.begin().then("right_claw", Animation.LoopType.PLAY_ONCE);

    public static final RawAnimation LEFT_TAIL = RawAnimation.begin().then("left_tail", Animation.LoopType.PLAY_ONCE);

    public static final RawAnimation RIGHT_TAIL = RawAnimation.begin().then("right_tail", Animation.LoopType.PLAY_ONCE);
